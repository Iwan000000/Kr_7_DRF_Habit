...
class Habit(models.Model):
    ...
    associated_nice_habit = models.ForeignKey("self", on_delete=models.SET_NULL, **NULLABLE,
                                              verbose_name='Сопутствующая приятная привычка')
    ...
    duration_time = models.DurationField(verbose_name='Продолжительность')
